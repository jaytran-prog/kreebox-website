(function () {
  ...
  const GREETING_EN = "Hey! I'm Phuong Tran 👋 Lead UX/UI Designer & Product Design Manager based in Ho Chi Minh City. This AI assistant is something I designed and built myself, as a live example of how I work at the intersection of design and AI. Ask me about my projects, process, or what it's like being a designer who actually builds the things they design.";
  const GREETING_VI = "Chào bạn! Tôi là Phuong Tran 👋 Lead UX/UI Designer & Product Design Manager tại TP.HCM. AI assistant này chính tôi tự thiết kế lẫn xây dựng, như một ví dụ thực tế về cách tôi làm việc ở giao điểm giữa design và AI. Hỏi tôi về dự án, quy trình, hoặc cảm giác thế nào khi vừa là designer vừa tự tay build sản phẩm AI nhé.";
        ...
        <span class="chatbot-fab__icon chatbot-fab__icon--chat" aria-hidden="true">
          ...
          <svg class="cat-mascot" width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg" style="overflow:visible">
            ...
            <g class="cat-arm cat-arm--left">
              <line x1="18" y1="52" x2="9" y2="58" stroke="#1e1e2a" stroke-width="13" stroke-linecap="round"/>
              <line x1="18" y1="52" x2="9" y2="58" stroke="#363648" stroke-width="9" stroke-linecap="round"/>
              <circle cx="9" cy="58" r="7" fill="#2e2e40"/>
              <circle cx="9" cy="58" r="4.5" fill="#3c3c52"/>
            </g>

            <!-- Right arm — short sausage sticking out bottom-right -->
            <g class="cat-arm cat-arm--right">
              <line x1="42" y1="52" x2="51" y2="58" stroke="#1e1e2a" stroke-width="13" stroke-linecap="round"/>
              <line x1="42" y1="52" x2="51" y2="58" stroke="#363648" stroke-width="9" stroke-linecap="round"/>
              <circle cx="51" cy="58" r="7" fill="#2e2e40"/>
              <circle cx="51" cy="58" r="4.5" fill="#3c3c52"/>
            </g>
